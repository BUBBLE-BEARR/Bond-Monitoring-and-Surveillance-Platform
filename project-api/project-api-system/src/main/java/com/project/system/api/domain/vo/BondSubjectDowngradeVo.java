 ...
 * @author qshj
 */
public class BondSubjectDowngradeVo {
    /** 主键 */
    private Long bsdId;
    ...
    private String ratingAdjustmentDayStart;
    private String ratingAdjustmentDayEnd;
    ...
    public String getRatingAdjustmentDayStart() {
        return ratingAdjustmentDayStart;
    }

    public void setRatingAdjustmentDayStart(String ratingAdjustmentDayStart) {
        this.ratingAdjustmentDayStart = ratingAdjustmentDayStart;
    }

    public String getRatingAdjustmentDayEnd() {
        return ratingAdjustmentDayEnd;
    }

    public void setRatingAdjustmentDayEnd(String ratingAdjustmentDayEnd) {
        this.ratingAdjustmentDayEnd = ratingAdjustmentDayEnd;
    }
